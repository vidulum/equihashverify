...
#define EhInitialiseState(n, k, base_state)  \
    if (n == 96 && k == 3) {                 \
        ...
        Eh168_6.InitialiseState(base_state); \
    } else if (n == 96 && k == 5) {          \
                    ...
                    const std::function<bool(EhSolverCancelCheck)> cancelled)
{
    if (n == 96 && k == 3) {
        ...
        return Eh168_6.BasicSolve(base_state, validBlock, cancelled);
    } else if (n == 96 && k == 5) {
                    ...
                    const std::function<bool(EhSolverCancelCheck)> cancelled)
{
    if (n == 96 && k == 3) {
        ...
        return Eh168_6.OptimisedSolve(base_state, validBlock, cancelled);
    } else if (n == 96 && k == 5) {
...
#define EhIsValidSolution(n, k, base_state, soln, ret)   \
    if (n == 96 && k == 3) {                             \
        ...
        ret = Eh168_6.IsValidSolution(base_state, soln); \
    } else if (n == 96 && k == 5) {                      \
